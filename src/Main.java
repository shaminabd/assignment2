...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        File studentFile = new File("C:\\Users\\Chingishan\\IdeaProjects\\projectNumber1\\src\\students.txt");
        Scanner studentScanner = new Scanner(studentFile);

        File teacherFile = new File("C:\\Users\\Chingishan\\IdeaProjects\\projectNumber1\\src\\teachers.txt");
